    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="grid auto-rows-min gap-4 md:grid-cols-1">
                <div class="relative aspect-video overflow-hidden rounded-xl border-0">
                    <Card class="@container/card">
                        <CardHeader>
                            <CardTitle class="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
                                <div class="flex items-center justify-between">
                                    <HeadingSmall title="Orders information" description="More info about orders" />
                                    <CreateOrder :asset-options="assetOptions" :sides-options="sidesOptions" />
                                </div>
                            </CardTitle>
                            <CardContent class="tabular-nums">
